        ...
        <div>
            <div class="">
                <div class="panel-body">
                    <div class="col-md-12 heading" style="text-align: center;">
                    ...
                    <div class="col-md-12 heading" style="padding: 0px">
                        <table style="width: 100%;">
                            <tr style="border-bottom: 1px solid #000;">
                                ...
                                <td width="16%" style="border-left: 1px solid #000;">&nbsp;<b>To:</b> </td>
                    ...
                    <div class="col-md-12 heading" style="padding: 0px">
                        <table style="width: 100%;">
                            ...
                            <?php if($employee->employee_is_regular == 0 && $invoice['with_travelling_rate'] == 1){ ?>
                            <tr >
                                <td width="20%" style="padding-bottom: 20px;padding-left: 3px;">
                                    Travelling Rate:
                                    <?php if($rate['is_different_currency']){ ?>
                            ...
                            <?php } ?>
                            <?php if($rate['pl_rate'] != 0 && $invoice['with_project_leader_rate'] == 1){ ?>
                            <tr>
                                <td width="20%" style="padding-bottom: 20px;padding-left: 3px;">
                                    Project Leader Rate:
                                    <?php if($rate['is_different_currency']){ ?>
                                ...
                                <td width="15%" style="padding-bottom: 20px;border-left: 1px solid #000;vertical-align: top;">&nbsp;
                                    <span style="text-decoration: underline;"><?=$invoice['project_leader_rate_days']?></span> Day(s)
                                    <?php if($rate['is_different_currency']){ ?>
                                        <div>&nbsp;(1 <?=$rate['currency']?> - <?=number_format($rate['currency_average'], 2)?>)</div>
                                    <?php }?>
                                </td>
                                ...
                                <?php 
                                    $total_pl = round($rate['pl_rate'] * $rate['pl_currency_average'] * $invoice['project_leader_rate_days'], 2);
                                    $total += $total_pl;
                                ?>
                                <td width="20%" style="padding-bottom: 20px;border-left: 1px solid #000;vertical-align: top;" align="center"><?=$invoice['project_leader_rate_dates']?></td>
                            ...
                            <?php } ?>
                            <?php if($invoice['with_meal_allowance'] == 1){ ?>
                            <tr>
                                <td width="20%" style="padding-bottom: 20px;padding-left: 3px;">
                                    Meal Allowance: 
                                ...
                                <td width="15%" style="padding-bottom: 20px;border-left: 1px solid #000;">&nbsp;<span style="text-decoration: underline;"><?=$invoice['meal_allowance_days']?></span> Day(s) 
                                    <?php if($employee->employee_is_regular == 1 && $rate['meal_allowance_php_value'] != 1){ ?>
                                        <div>&nbsp;(1 <?=$rate['meal_currency']?> - <?=number_format($rate['meal_allowance_php_value'], 2)?>)</div>
                                    <?php }?>
                                </td>
                                <td width="25%" style="padding-bottom: 20px;">@ <?=$rate['meal_currency']?> <span style="text-decoration: underline;"><?=number_format($rate['meal_allowance'], 2)?></span> / Day
                                    <?php if($employee->employee_is_regular == 1 && $rate['meal_allowance_php_value'] != 1){ ?>
                                        <div>= PHP <?=number_format((round($rate['meal_allowance'] * $rate['meal_allowance_php_value'], 2)), 2)?></div>
                                    <?php }?>
                                </td>
                                <td width="20%" style="padding-bottom: 20px;border-left: 1px solid #000;" align="center"><?=$invoice['meal_allowance_dates']?></td>
                                <?php
                            ...
                            <?php } ?>
                            <?php if($invoice['with_visa_application'] == 1){ ?>
                            <tr>
                                <td width="20%" style="padding-bottom: 20px;padding-left: 3px;">Visa Application: </td>
                                <td width="15%" style="padding-bottom: 20px;border-left: 1px solid #000;">&nbsp;<span style="text-decoration: underline;"><?=$invoice['visa_application_days']?></span> Day(s)</td>
                                ...
                                <td width="20%" style="padding-bottom: 20px;border-left: 1px solid #000;" align="center"><?=$invoice['visa_application_dates']?></td>                                
                                <?php 
                                    $total_visa = round($rate['visa_rate'] * $invoice['visa_application_days'], 2);
                                    $total += $total_visa;
                                ?>
                                <td width="20%" style="padding-bottom: 20px;border-left: 1px solid #000;" align="center">
                            ...
                            <tr>                     
                                ...
                                <td width="20%" style="border-left: 1px solid #000;background-color: #eee  !important;">&nbsp;TOTAL:</td>
                                <td width="20%" style="border-left: 1px solid #000;border-right: 1px solid #000;background-color: #ddd  !important;" align="center">
                                    <span style="position: absolute;right: 140px;">₱</span>
                            ...
                            <tr style="border-bottom: 1px solid #000;">
                                <td width="20%" style="padding-bottom: 20px;"></td>
                                <td width="15%" style="padding-bottom: 20px;border-left: 1px solid #000;"></td>
                                <td width="25%" style="padding-bottom: 20px;"></td>
                                <td width="20%" style="padding-bottom: 20px;border-left: 1px solid #000;vertical-align: top;"></td>
                                <td width="20%" style="padding-bottom: 20px;border-left: 1px solid #000;vertical-align: top;"></td>
                            </tr>
                            <tr style="border-bottom: 1px solid #000;">
                                <td width="80%" colspan="4" align="center"><b>TOTAL RECEIVABLES</b></td>
                                <td width="20%" align="center" style="border-left: 1px solid #000;border-right: 1px solid #000;background: #ff867c !important;color:#7f0000 !important;">
                                    <span style="position: absolute;right: 140px;">₱</span> 
                                    <b>
