    ...
    <form method="POST" id="invoice_form">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Create Invoice</h4> </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="project_scope" placeholder="Project Scope" class="form-control" required="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" name="for_refund" placeholder="For Refund (Optional)" value="0" class="form-control"> 
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="checkbox checkbox-primary m-b-20">
                                        <input type="checkbox" id="with_travelling_rate" name="with_travelling_rate" class="others_checkbox">
                                        <label for="with_travelling_rate">With Travelling Rate</label>
                                    </div>
                                    <div style="display: none;" class="with_travelling_rate">
                                        <div class="col-md-4 m-b-20">
                                            <label>Number of Days</label>
                                            <input type="number" name="travelling_days" value="0" class="form-control" required="" placeholder="Travelling Rate Days">
                                        </div>
                                        <div class="col-md-8 m-b-20">
                                            <label>Dates</label>
                                            <input type="text" name="travelling_start_date" class="form-control" required="" placeholder="Dates (Ex. August 14, 2018 / August 16, 2019-August 19, 2019)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="checkbox checkbox-primary m-b-20">
                                        <input type="checkbox" id="with_project_leader_rate" name="with_project_leader_rate" class="others_checkbox">
                                        <label for="with_project_leader_rate">With Project Leader Rate</label>
                                    </div>
                                    <div style="display: none;" class="with_project_leader_rate">
                                        <div class="col-md-12 m-b-20">
                                            <div class="radio radio-primary">
                                                <input type="radio" name="pl_is_local" id="pl_is_local_1" value="1" checked="">
                                                <label for="pl_is_local_1"> Local </label>
                                            </div>
                                            <div class="radio radio-primary">
                                                <input type="radio" name="pl_is_local" id="pl_is_local_0" value="0">
                                                <label for="pl_is_local_0"> International </label>
                                            </div>
                                        </div>
                                        <div class="col-md-3 m-b-20">
                                            <label>Number of Days</label>
                                            <input type="number" name="project_leader_days" value="0" class="form-control" required="" placeholder="Project Leader Rate Days">
                                        </div>
                                        <div class="col-md-9 m-b-20">
                                            <label>Dates</label>
                                            <input type="text" name="project_leader_start_date" class="form-control" required="" placeholder="Dates (Ex. August 14, 2018 / August 16, 2019-August 19, 2019)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="checkbox checkbox-primary m-b-20">
                                        <input type="checkbox" id="with_meal_allowance" name="with_meal_allowance" class="others_checkbox">
                                        <label for="with_meal_allowance">With Meal Allowance</label>
                                    </div>
                                    <?php if($employee->employee_is_regular == 0){ ?>
                                    <div style="display: none;" class="with_meal_allowance">
                                        <div class="col-md-6 m-b-20">
                                            <label>Number of Days</label>
                                            <input type="number" name="meal_allowance_days" value="0" class="form-control" required="" placeholder="Meal Allowance Rate Days">
                                        </div>
                                        <div class="col-md-6 m-b-20">
                                            <label>Dates</label>
                                            <input type="text" name="meal_allowance_start_date" class="form-control" required="" placeholder="Dates (Ex. August 14, 2018 / August 16, 2019-August 19, 2019)">
                                        </div>
                                    </div>
                                    <?php }else{ ?>
                                    <div style="display: none;" class="with_meal_allowance">
                                        ...
                                        <div class="col-md-3 m-b-20">
                                            ...
                                            <input type="text" name="meal_allowance_currency" value="PHP" class="form-control" required="" placeholder="Meal Allowance Rate Days">
                                        </div>
                                        <div class="col-md-9 m-b-20">
                                            <label>Value in PHP (note* If currency is PHP, just input 1.)</label>
                                            <input type="number" step="0.01" name="meal_allowance_php_value" class="form-control" required="" placeholder="PHP value" value="1">
                                        </div>
                                        <div class="col-md-12 m-b-20">
                                            <label>Meal Rate / day</label>
                                            <input type="number" step="0.01" name="meal_allowance_rate" class="form-control" required="" placeholder="Meal Rate / day">
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="checkbox checkbox-primary m-b-20">
                                        <input type="checkbox" id="with_visa_application" name="with_visa_application" class="others_checkbox">
                                        <label for="with_visa_application">With VISA Application</label>
                                    </div>
                                    <div style="display: none;" class="with_visa_application">
                                        <div class="col-md-12 m-b-20">
                                            <div class="radio radio-primary">
                                                <input type="radio" name="visa_application_is_local" id="visa_application_is_local_1" value="1" checked="">
                                                <label for="visa_application_is_local_1"> Local </label>
                                            </div>
                                            <div class="radio radio-primary">
                                                <input type="radio" name="visa_application_is_local" id="visa_application_is_local_0" value="0">
                                                <label for="visa_application_is_local_0"> International </label>
                                            </div>
                                        </div>
                                        <div class="col-md-3 m-b-20">
                                            <label>Number of Days</label>
                                            <input type="number" name="visa_days" value="0" class="form-control" required="" placeholder="Visa Application Rate Days">
                                        </div>
                                        <div class="col-md-9 m-b-20">
                                            <label>Dates</label>
                                            <input type="text" name="visa_start_date" class="form-control datepicker" required="" placeholder="Dates (Ex. August 14, 2018 / August 16, 2019-August 19, 2019)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Number of Days</label>
                                    <input type="number" name="daily_rate_days" id="daily_rate_days" value="0" class="form-control" required="" placeholder="Daily Rate Days">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Dates</label>
                                    <input type="text" name="daily_rate_dates" class="form-control" required="" placeholder="Dates (Ex. August 14, 2018 / August 16, 2019-August 19, 2019)">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?=base_url()?>asset/src/invoice/form.js"></script>