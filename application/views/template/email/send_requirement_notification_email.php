            ...
            <tr>
                <td>
                    ...
                    <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
                        New Requirement Update. (This is an auto-generated email from Hotwork CMS)
                    </div>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                                <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 16px; line-height: 30px; color: #333333; font-weight: normal;">Hi Admin,</h1>
                                                <p style="margin: 0;">Mr. <?=$name;?> uploaded his requirements on Hotwork CMS!</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                                <h2 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 15px; line-height: 22px; color: #333333; font-weight: bold;">Requirements Uploaded: </h2>
                                                <ul style="padding: 0; margin: 0 0 10px 0; list-style-type: disc;">
                                                    <li style="margin: 0 0 10px 30px;" class="list-item-first"><?= html_entity_decode(htmlspecialchars_decode($requirements)); ?></li>
                                                    <li style="margin: 0 0 10px 30px;">Date Uploaded: <?=$uploaded_date;?></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <!-- Button : BEGIN -->
