            ...
            <tr>
                <td>
                    ...
                    <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
                        New task. (This is an auto-generated email from Hotware)
                    </div>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                                <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 16px; line-height: 30px; color: #333333; font-weight: normal;">Hi <?= $task->user_firstname ?>,</h1>
                                                <p style="margin: 0;">A new task has been assigned to you. Kindly check the details before for your reference. Thank you.</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                                <h2 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 15px; line-height: 22px; color: #333333; font-weight: bold;">Task Details: </h2>
                                                <ul style="padding: 0; margin: 0 0 10px 0; list-style-type: disc;">
                                                    <li style="margin: 0 0 10px 30px;" class="list-item-first">Task Name.: <?= $task->task_name; ?></li>
                                                    <li style="margin: 0 0 10px 30px; text-align: justify;" >Description: <?= html_entity_decode(htmlspecialchars_decode($task->task_description)); ?></li>
                                                    <li style="margin: 0 0 10px 30px;">Task Priority: <?= $task->task_priority_level; ?></li>
                                                    <li style="margin: 0 0 10px 30px;" class="list-item-last">Date Added: <?= $task->task_trigger_date; ?></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <!-- Button : BEGIN -->
