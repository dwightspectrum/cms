      	...
      	<div class="new-login-box">
            <div class="white-box" style="border: 1px solid #c7c7c7;box-shadow: 0px 0px 20px 10px rgb(136 136 137 / 64%);">
                <div style="display:flex; justify-content: space-between;">
                    ...
                    <div>
                        <p><a href="<?=base_url()?>login"><u>Back</u></a></p>
                    </div>
                </div>
                  <form class="form-horizontal new-lg-form" id="" action="<?=base_url()?>login/login_freelancer_credentials" method="POST">
                    
                    <div class="form-group  m-t-20">
                      	<div class="col-xs-12">
                        	<label>Username</label>
                        	<input class="form-control" name="freelancer_username" type="text" required="" placeholder="Freelancer Username">
                      	</div>
                    </div>
                    <div class="form-group">
                      	<div class="col-xs-12">
                        	<label>Password</label>
                        	<input class="form-control" name="freelancer_password" type="password" required="" placeholder="Freelancer Password">
                      	</div>
                    </div>
