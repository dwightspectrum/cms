    ...
    <div class="white-box m-t-30">
        <div class="header-white-box">
            <div class="guidelines-wrapper">
                <h3 class="box-title m-b-0">EMPLOYEE EVALUATION REPORT</h3>
                <ul class="guidelines">
            ...
            <div class="button-wrapper">
                <button class="btn btn-primary" type="button" id="submit">Evaluate</button>
            </div>
...
<script type="text/javascript" src="<?=base_url()?>asset/src/employee/evaluation_report.js"></script>
