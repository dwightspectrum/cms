                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Name</label>
                                    <div><?=$employee->employee_fullname?></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Address</label>
                                    <div><?=$employee->employee_city_address?></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Email</label>
                                    <div><?=$employee->employee_office_email?></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- <div class="form-group"> -->
                                    ...
                                    <div><?=$employee->employee_landline_number?></div>
                                <!-- </div> -->
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="white-box">
                        <div class="form-group">
                            ...
                            <input type="text" id="employee_address_zip_code" name="employee_address_zip_code" class="form-control" placeholder="Address" value="<?=($cv)? $cv->employee_address_zip_code : ''?>"> 
                        </div>
                        <div class="form-group">
                            <label>Desired Position</label>
                            <input type="text" id="employee_desired_position" name="employee_desired_position" class="form-control" placeholder="Position" value="<?=($cv)? $cv->employee_desired_position : ''?>"> 
                        </div>
                    </div>
                 </div>
                 <div class="row">
...
<tr>    
  ...
  <td data-content='employee_position'></td>
  <td data-content='employee_year'></td>
...
<tr>    
  <td data-content='employee_skill_name'></td>
  <td data-content='action'></td>
</tr> 
</script>
...
<tr>    
  <td data-content='employee_language_name'></td>
  <td data-content='action'></td>
</tr> 
</script>
...
<tr>    
  <td data-content='employee_hobby_name'></td>
  <td data-content='action'></td>
</tr> 
</script>
...
<tr>    
  <td data-content='employee_reference_name'></td>
  <td data-content='employee_reference_company'></td>
  <td data-content='employee_reference_position'></td>
  <td data-content='employee_reference_contact_no'></td>
  <td data-content='action'></td>
</tr> 
</script>

<script type="text/javascript" src="<?=base_url()?>asset/src/employee/curriculum_vitae.js"></script> 