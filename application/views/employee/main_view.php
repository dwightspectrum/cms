  ...
  <div class="white-box">
    <div class="main-body">
      <div aria-label="breadcrumb" class="main-breadcrumb">
        <h1>Welcome,<i> <?=$employee->employee_first_name?></i></h1>
      </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                  <a href="javascript:void(0)"><img src="<?=base_url()?>asset/employees/<?=$employee->employee_photo?>" class="img-fluid img-thumbnail" alt="img" width="60%"></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card mb-3">
              <div class="card-body" style="padding-left: 5%;">
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary" style="margin-top: 5px; font-size: large;"><?=$employee->employee_first_name . ", " . $employee->employee_middle_name . " " . $employee->employee_last_name;?></div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-sm-3">
                    ...
                    <h5 class="col-sm-9 text-secondary" style="margin-top: 5px; font-size: large;"><?=$employee->employee_personal_email?></h5>
                </div>
                <hr>
                <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary" style="margin-top: 5px; font-size: large;"><?=$employee->employee_mobile_number?></div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary" style="margin-top: 5px; font-size: large;" font-size: x-large;><?=$employee->employee_city_address?></div>
                </div>
            </div>
          </div>
        </div>
    ...
    <div class="row" style="width: 85%; height: auto; margin: auto;">
        <div class="text-justify text-muted" style= "font-size: 17px;">
            ...
            <br><p><strong><u><a href="<?=base_url()?>employee/profile/<?=($employee->employee_id)?>"> Click here</a></u></strong> to proceed submitting your requirements.</p>
            <br><br><br>
        </div>
    </div>
  </div>
