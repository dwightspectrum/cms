 <div class="container-fluid">
      ...
      <div class="row bg-title">
         ...
         <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <ol class="breadcrumb m-t-10">
               <li><a href="<?=base_url()?>dashboard">Employee</a></li>
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input type="text" id="employee_job_history_client" name="employee_job_history_client" class="form-control" placeholder="Our direct contact">
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group">
                           <label>Location</label><br><br>
                           <select class="form-control require" id="employee_job_location" name="employee_job_location">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                           ...
                           <input type="text" id="employee_job_history_scope" name="employee_job_history_scope" class="form-control" placeholder="Target area of our job (Combustion Area, Cyclone, Inlet/Outlet, Etc.)"><br>
                        </div>
                     </div>
                     <!-- <div class="col-md-12">
                        <div class="form-group">
   ...
   <div class="col-sm-5 p-0">
      <form method="POST" id="employee_survey_form" autocomplete="off">
         <div class="white-box">
                  ...
                  <div class="row">
                     <div class="col-md-10 p-0">
                        <div class="form-group">
                           ...
                           <input type="hidden" id="survey_email_id" name="survey_email_id">
                           <!-- <input pattern="[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}" type="email" id="survey_email" name="survey_email" class="form-control" placeholder="Email address" required>  -->
                           <!-- <input type="email" id="survey_email" name="survey_email" class="form-control" placeholder="Email address" required>  -->
                        </div>
                     </div>
                     <div class="col-md-2">
                        <div class="form-group">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input type="text" id="employee_job_address" name="employee_job_address" class="form-control" placeholder="Our direct contact">
                        </div>
                     </div>
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input type="text" class="form-control datepicker-autoclose" id="employee_job_departure_date" name="employee_job_departure_date" placeholder="yyyy-mm-dd"><span class="input-group-addon"><i class="icon-calender"></i></span>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input type="text" class="form-control datepicker-autoclose" id="employee_job_return_date" name="employee_job_return_date" placeholder="yyyy-mm-dd"><span class="input-group-addon"><i class="icon-calender"></i></span>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="form-body">
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           <label>Country</label>
                           <input type="text" id="employee_job_country" name="employee_job_country" class="form-control" placeholder="Our direct contact">
                        </div>
                     </div>
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input type="text" class="form-control datepicker-autoclose" id="employee_job_entry_date" name="employee_job_entry_date" placeholder="yyyy-mm-dd" required=""><span class="input-group-addon"><i class="icon-calender"></i></span>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input type="text" class="form-control datepicker-autoclose" id="employee_job_exit_date" name="employee_job_exit_date" placeholder="yyyy-mm-dd" required=""><span class="input-group-addon"><i class="icon-calender"></i></span>
                           </div>
                     </div>
                  </div>
               </div>
...
<script type="text/html" id="job-data-template">
   <tr>
       <td data-content='employee_job_history_client' data-value='employee_job_history_id'></td>
       <td data-content='employee_job_history_scope'></td>
       <td data-content='employee_job_location'></td>
       <td data-content='employee_job_address' data-content='employee_job_country'></td>
       <td data-content='employee_job_departure_date' data-content='employee_job_entry_date'></td>
       <td data-content='employee_job_return_date' data-content='employee_job_exit_date'></td>
       <!-- <td data-content='employee_job_country'></td> -->
       <!-- <td data-content='employee_job_entry_date'></td> -->
       <!-- <td data-content='employee_job_exit_date'></td> -->
       <td data-content='service_scope_name'></td>
       <td data-content='action' class='text-right' colspan='1'>
         <a title="Delete" class="btn btn-danger btn-sm m-r-5 remove-job" data-id="employee_job_history_id"><i class="fa fa-trash"></i></a>
       </td>
   </tr>
</script>
...
<script type="text/html" id="survey_template">
    <tr>
      <!-- <td data-content="employee_id"></td> -->
...
<script type="text/html" id="select_client_template">
   <option data-content='employee_job_history_client' data-value="employee_job_history_id"></option>
</script>

<script src="<?=base_url()?>asset/components/plugins/bower_components/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>asset/src/employee/job_history.js"></script>
