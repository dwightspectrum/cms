                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control datepicker-autoclose" id="purchase_order_arrival_date" name="purchase_order_arrival_date" placeholder="yyyy-mm-dd" autocomplete="off" required=""> <span class="input-group-addon"><i class="icon-calender"></i></span> 
                                    </div> 
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control datepicker-autoclose" id="purchase_order_departure_date" name="purchase_order_departure_date" placeholder="yyyy-mm-dd" autocomplete="off" required=""> <span class="input-group-addon"><i class="icon-calender"></i></span> 
                                    </div> 
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                    ...
                                    <input type="file" name="purchase_order_acceptance_report" id="purchase_order_acceptance_report" autofocus required=""> </span> 
                                    <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a> 
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label>Log Sheets (<i>Please attached a zip file if more than one.</i>)</label>
                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                    <div class="form-control" data-trigger="fileinput"> 
                                        <i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename"></span>
                                    </div> 
                                    <span class="input-group-addon btn btn-default btn-file"> <span class="fileinput-new">Select file</span> <span class="fileinput-exists">Change</span>
                                    <input type="file" name="purchase_order_logsheets" id="purchase_order_logsheets" autofocus  required=""> </span> 
                                    <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a> 
                                </div>
                            </div>
                        </div>
