$(document).ready(function(){
	...
	$('#update_pull_out_details_form').submit(function(e){
	    e.preventDefault();
	    ...
	    var qf = $('#po_trucking_quotation_file_name').val();
	    ...
	    $.ajax({
	      type: 'POST',
	      url: CONFIG.BASE_URL + 'purchaseorder/update_pull_out_details_data/' + CONFIG.purchase_order_id,
	      dataType: 'json',
	      ...
	      success: function(result){
	        ...
	        alertify.success("Pull out details are successfully updated!");
	...
	function set_trucking_to_not_complete(){
		$.ajax({
            ...
            success: function(result){
            	setTimeout(function () { 
		          window.location.href = CONFIG.BASE_URL + 'purchaseorder/edit_pull_out_details/' + CONFIG.purchase_order_id; 
		        }, 1000);
            }
        });
	}
