$(document).ready(function(){
	...
	$('#submit-invoice').on('click', function(e){
		...
		$.ajax({
            type: 'POST',
            url: CONFIG.BASE_URL + 'invoice/submit/',
            dataType: 'json',
            data: {
            	invoice: $('#invoice_form').serialize(),
	...
	$('#preview-invoice').on('click', function(e){
		...
		window.open(CONFIG.BASE_URL + 'invoice/preview/?' + $('#invoice_form').serialize() + '&' + $.param(advances) + '&' + $.param(project_dates), '_blank');
	});
