$(document).ready(function(){
    ...
    function set_prof_exp_data(){
      var data = {
        ...
        'freelancer_position' : $('#company_position').val(),
        'freelancer_year' : $('#company_year').val()
      };
    ...
    function set_skill_data(){
      var data = {
        'freelancer_skill_name' : $('#skill_name').val()
      };
    ...
    function set_language_data(){
      var data = {
        'freelancer_language_name' : $('#language').val()
      };
    ...
    function set_hobby_data(){
      var data = {
        'freelancer_hobby_name' : $('#hobby').val()
      };
    ...
    function set_reference_data(){
      var data = {
        'freelancer_reference_name' : $('#reference_name').val(),
        'freelancer_reference_company' : $('#reference_company').val(),
        'freelancer_reference_position' : $('#reference_position').val(),
        'freelancer_reference_contact_no' : $('#reference_contact').val()
      };
    ...
    $('#curriculum_vitae_form').submit(function(e){
      ...
      $.ajax({
        type: 'POST',
        url: CONFIG.BASE_URL + 'freelancer/update_curriculum_vitae/' + CONFIG.freelancer_id,
        dataType: 'json',
        processData: false,
        contentType: false,
        cache: false,
        ...
        success: function(result){
          ...
          setTimeout(function () { 
            window.location.href = CONFIG.BASE_URL + 'freelancer/profile/' + CONFIG.freelancer_id;
          }, 500);
